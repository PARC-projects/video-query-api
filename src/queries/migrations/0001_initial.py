# Generated by Django 2.0.5 on 2018-05-15 23:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('clip', models.PositiveIntegerField(help_text='clip number, positive integer')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, to='queries.SearchSet'),
        ),
        migrations.AddField(
            model_name='query',
            name='video',
