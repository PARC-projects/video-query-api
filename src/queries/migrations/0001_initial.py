    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nearmatches', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveIntegerField(), default=[3, 4], size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=254, unique=True)),
                ('video_dataset', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='queries.Dataset')),
            ],
            options={
                'db_table': 'video',
            },
        ...
        migrations.AddField(
            model_name='query',
            name='video_dataset',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='queries.Dataset'),
        ),
        migrations.AddField(
            model_name='matcharray',
            name='query_name',
