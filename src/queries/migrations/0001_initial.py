# Generated by Django 2.2.4 on 2019-08-12 14:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('query_result', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='queries.QueryResult')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_clip', models.ForeignKey(help_text='Id in the video_clips table for the clip corresponding to this row.', on_delete=django.db.models.deletion.PROTECT, to='queries.VideoClip')),
            ],
            options={
                'db_table': 'feature',
