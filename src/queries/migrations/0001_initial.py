# Generated by Django 2.0 on 2018-02-26 15:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dnn_stream', models.ForeignKey(help_text='DNN stream name from dnn_streams table signifying which of the streams in the multi-stream DNN this row belongs.', on_delete=django.db.models.deletion.PROTECT, to='queries.DnnStream')),
            ],
            options={
                'db_table': 'feature',
            },
