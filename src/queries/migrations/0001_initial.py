# Generated by Django 2.0.5 on 2018-08-17 04:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_report_file', models.FileField(help_text='final csv report. For coreapi, use encoding in client.action() asclient.action(..., encoding="multipart/form-data")', max_length=254, upload_to='final_reports/')),
