# Generated by Django 2.2.8 on 2020-03-19 16:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_report_file', models.FileField(help_text='final csv report. For coreapi, use encoding in client.action(): client.action(..., encoding="multipart/form-data")', max_length=254, null=True, upload_to='final_reports/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('length_in_seconds', models.PositiveIntegerField(blank=True, default=None, null=True)),
            ],
            options={
                'db_table': 'video',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.ForeignKey(help_text='Id in the video table for the video corresponding to this clip', on_delete=django.db.models.deletion.CASCADE, to='queries.Video')),
            ],
            options={
                'db_table': 'video_clip',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('videos', models.ManyToManyField(to='queries.Video')),
            ],
            options={
                'db_table': 'search_set',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bootstrapped_target', django.contrib.postgres.fields.jsonb.JSONField(default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_clip', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='queries.VideoClip')),
            ],
            options={
                'db_table': 'match',
                'ordering': ('-score',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dnn_stream', models.ForeignKey(help_text='DNN stream name from dnn_streams table signifying which of the streams in the multi-stream DNN this row belongs.', on_delete=django.db.models.deletion.CASCADE, to='queries.DnnStream', to_field='type')),
                ('video_clip', models.ForeignKey(help_text='Id in the video_clips table for the clip corresponding to this row.', on_delete=django.db.models.deletion.CASCADE, to='queries.VideoClip')),
            ],
            options={
                'db_table': 'feature',
